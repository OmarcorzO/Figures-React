...
const PageWithScrollControl = () => {
  ...
  const line = "M340 420C833-414 2558-353 2904 410";
  // const line = "M772.4661 187.9251C838.2867 187.9251 891.6468 134.5272 891.6468 68.658 891.6468 2.7888 838.2867-50.6091 772.4661-50.6091 706.6455-50.6091 653.2854 2.7888 653.2854 68.658 653.2854 134.5272 706.6455 187.9251 772.4661 187.9251ZM340 420C840-335 2642-635 2904 410";
            ...
            >
              ...
              <>
                ...
                <motion.circle
                  ...
                  transition={{
                    delay: !mathPosition() ? 1.3 : 0, // Cada esfera aparece con un retras :o
                    duration: !mathPosition() ? 1 : 0,
                    ease: "easeInOut",
                  }}
                />
